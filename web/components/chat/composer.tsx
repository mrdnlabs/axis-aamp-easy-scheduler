...
interface ComposerProps {
  ...
  /**
   * When true, the composer is non-interactive — textarea and buttons
   * are all disabled. Use ``disabledReason`` to tell the user why
   * (rendered in the footer in place of the usual helper text).
   */
  disabled?: boolean;
 ...
 *   │                                                   │
 *   ├──────────────────────────────────────────────────┤
 *   │ 📎  Changes confirm before apply…       ⌘↵ [Send] │
 *   └──────────────────────────────────────────────────┘
 *
 * Above the card, when files are queued, an attachment chip strip
 * shows what'll be sent. Submit on Cmd/Ctrl+Enter.
 */
